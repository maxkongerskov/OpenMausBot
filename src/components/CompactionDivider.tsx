...
/** Quiet transcript marker for a harness-owned session recycle. Earlier
 * messages stay in the thread; the model received only the state vector. */
  ...
  return (
    <div className="px-5 py-2">
      ...
      >
        ...
        Context refreshed — earlier messages are still here
      </button>
      {open && summary && (
