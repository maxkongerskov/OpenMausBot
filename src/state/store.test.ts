  ...
  it("keeps the room turn timeout with the existing config fields", () => {
    expect(
      configStatusFromFrame({
        ...
        compaction: { compactAround: 128_000, vectorBudget: null, prompt: null, keepVectors: false, vectorArchiveDir: null, envOverride: null },
...
describe("Teach a skill feature flag", () => {
  const config = configStatusFromFrame({
    ...
    compaction: { compactAround: null, vectorBudget: null, prompt: null, keepVectors: false, vectorArchiveDir: null, envOverride: null },
