  ...
  it("keeps thread capacity and room timeout with the existing config fields", () => {
    expect(
      configStatusFromFrame({
        ...
        compaction: { enabled: true, compactAround: 128_000, vectorBudget: null, prompt: null, keepVectors: false, vectorArchiveDir: null, envOverride: null },
...
describe("config status", () => {
  const config = configStatusFromFrame({
    ...
    compaction: { enabled: true, compactAround: null, vectorBudget: null, prompt: null, keepVectors: false, vectorArchiveDir: null, envOverride: null },
