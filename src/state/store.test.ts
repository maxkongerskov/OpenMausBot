  ...
  it("keeps the room turn timeout with the existing config fields", () => {
    expect(
      configStatusFromFrame({
        ...
        compaction: { enabled: true, compactAround: 128_000, vectorBudget: null, prompt: null, keepVectors: false, microVectorsEnabled: false, bootstrapHybrid: false, vectorArchiveDir: null, envOverride: null },
...
describe("Teach a skill feature flag", () => {
  const config = configStatusFromFrame({
    ...
    compaction: { enabled: true, compactAround: null, vectorBudget: null, prompt: null, keepVectors: false, microVectorsEnabled: false, bootstrapHybrid: false, vectorArchiveDir: null, envOverride: null },
